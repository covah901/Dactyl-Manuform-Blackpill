...
[_QWERTY] = LAYOUT(
    ...
    KC_LCTL, KC_LALT, LOWER,   KC_SPC,  KC_LGUI, FN,      FN2,      KC_SPC,    KC_SPC,   RAISE,   KC_LEFT, KC_RGHT,
...
[_LOWER] = LAYOUT(
    ...
    _______, _______, _______, _______, _______, _______, _______,  _______,   _______,  KC_TRNS, KC_VOLU, KC_VOLD,
    KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_A,    KC_B,    KC_MPLY,  KC_MNXT,   KC_NO,    KC_NO,   KC_NO,   KC_NO
),

[_RAISE] = LAYOUT(
    _______, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,     KC_7,      KC_8,     KC_9,    KC_0,    KC_DEL,
    KC_TILD, _______, _______, _______, _______, _______, _______,  KC_MINS,   KC_EQL,   KC_LBRC, KC_RBRC, KC_BSLS,
...
[_FN] = LAYOUT(
    ...
    _______, _______, _______, _______, _______, _______, _______,  _______,   _______,  KC_TRNS, KC_VOLU, KC_MPLY,
    KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_HOME, KC_END,  KC_PGDN,  KC_PGUP,   KC_NO,    KC_NO,   KC_NO,   KC_NO
),

[_FN2] = LAYOUT(
    _______, _______, KC_UP,   _______, _______, KC_NO,   KC_NO,    KC_NO,     KC_UP,    KC_NO,   KC_PSCR, KC_NO,
    _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, KC_NO,    KC_LEFT,   KC_DOWN,  KC_RGHT, KC_NO,   KC_BSLS,
