...
#define PRODUCT         dactyl_blackpill
#define DESCRIPTION     ARM Split Dactyl
...
#define MATRIX_ROW_PINS { B12, B13, B15, A8, A10  }
#define MATRIX_COL_PINS_RIGHT { A15, B4, B5, B10, B0, A7 }
#define MATRIX_ROW_PINS_RIGHT { B12, B13, B15, A8, A10 }
